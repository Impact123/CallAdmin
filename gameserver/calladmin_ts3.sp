...
public void OnPluginStart()
{
	...
	g_hUrl     = view_as<ConVar> AutoExecConfig_CreateConVar("sm_calladmin_ts3_url", "http://calladmin.yourclan.eu/ts3", "Url to the ts3 folder of the webscripts", FCVAR_PLUGIN|FCVAR_PROTECTED);
